...
-- /kafka/ED3F80826F05C523B3CA9BD1FB75A63D/get.txt Path for the default directory, modify need pairing with the server
...
--
local kafka_uri_1 = "http://{kafka2http serer addr/domain}/kafka/ED3F80826F05C523B3CA9BD1FB75A63D/get.txt?maxbuf=4000&partition="
